...
typedef enum {
    ...
    ES_TIMEOUT, /* signals that the timer has expired: 7 */
    ES_TIMERACTIVE, /* signals that a timer has become active: 8 */
    ...
    DONE_SHOOT, // 32
    RELOAD_SPOTTED, // 33
    NEED_ADJUSTMENT, // pins for sensing which direction are high
    STOP, // event means time to stop
    NUMBEROFEVENTS,
} ES_EventTyp_t;
...
#define EVENT_CHECK_LIST  CheckBumpers, CheckDestination, CheckCam
