 ...
 * PUBLIC #DEFINES                                                             *
 ******************************************************************************/
// For Correct offset in dif files 
#define HighMiddle 572
#define LowMiddle 452
#define Middle 512
...
#define EvadeTimer 3 // used in HitSub.c
#define FlywheelWarmUp 4
#define WaitGate 5
#define ReloadTimer 6 // For waiting after reload


// Bumper Events
// wil this worlk? use instead of 4 cases for a hit maybe
#define AnyBumperHit FL_BUMPER_HIT | FR_BUMPER_HIT | RL_BUMPER_HIT | RR_BUMPER_HIT
